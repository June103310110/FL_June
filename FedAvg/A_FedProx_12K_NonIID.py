...
hyper_para['split_method'] = str(split_method['method']).split(' ')[1]
...
#             print('epoch = ',epoch)
            ...
            for step, (x_batch_train, y_batch_train) in enumerate(train_dataset):
                ...
                with tf.GradientTape() as tape:
                    ...
                    diff_2norm =  tf.norm([tf.norm(a) for a in new_weights])
    #                 print('diff norm', diff_2norm)

                    
                    proximal_term = 0.5*u*diff_2norm
#                     print('loss--',loss_value)
#                     print('loss+proxi---',loss_value+proximal_term)
